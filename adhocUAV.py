...
def topology():
    ...
    sta4 = net.addStation('sta4', mac='00:00:00:00:00:05', ip='10.0.0.5/8', antennaHeight='1', antennaGain='5')
    sta5 = net.addStation('sta5', mac='00:00:00:00:00:06', ip='10.0.0.6/8', antennaHeight='1', antennaGain='5')
    sta6 = net.addStation('sta6', mac='00:00:00:00:00:07', ip='10.0.0.7/8', antennaHeight='1', antennaGain='5')
    ...
    #net.setPropagationModel(model="logNormalShadowing", exp=4.5, variance=10)
